...
public class CommandsTest {
    ...
    public void testValidDriverCmd() {
        ...
        Assertions.assertEquals("Naimish", matcher.group(2).trim());
        // case sensitive test
        input = "driver Naimish Viradia";
        matcher = Commands.DRIVER.matcher(input);
        Assertions.assertTrue(matcher.find());
        Assertions.assertEquals("driver", matcher.group(1).trim());
        Assertions.assertEquals("Naimish Viradia", matcher.group(2).trim());
    }
    ...
    public void testValidTripCmd() {
        ...
        Assertions.assertEquals("Naimish", matcher.group(2).trim());
        Assertions.assertEquals("07:10", matcher.group(3).trim());
        Assertions.assertEquals("07:12", matcher.group(5).trim());
        Assertions.assertEquals("17.3", matcher.group(6).trim());
        ...
        matcher = Commands.TRIP.matcher(input);
        Assertions.assertTrue(matcher.find());
        Assertions.assertEquals("17", matcher.group(6).trim());
    }
